...
<template>
  <div class="p-6 bg-[#adadad] h-[150px] flex flex-col items-center justify-center rounded-md">
    <Transition name="fade" mode="out-in">
      <div :key="resultQuote" class="flex flex-col gap-2">
        <span class="text-black font-body text-xl italic font-weight-medium">
          {{ resultQuote }}
        </span>
  ...
  <div class="flex justify-between">
    <button class="btn btn-neutral text-lg w-1/4" ref="buttonRef" @click="getQuote">
      Submit a quote
    </button>
